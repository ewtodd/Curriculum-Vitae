...
\begin{minipage}[t]{\textwidth}
	\begin{small}
		...
		\begin{itemize}
			...
			\item Awarded NSUF Rapid Turnaround Experiment grant to conduct an additional measurement of the final gamma-ray energy at the Ohio State Nuclear Reactor Laboratory in early 2026.  		\end{itemize}
	\end{small}
\end{minipage}
